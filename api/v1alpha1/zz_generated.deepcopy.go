...
func (in *DBaaSProviderSpec) DeepCopyInto(out *DBaaSProviderSpec) {
	*out = *in
	...
	if in.InstanceParameterValues != nil {
		in, out := &in.InstanceParameterValues, &out.InstanceParameterValues
		*out = make([]InstanceParameterValue, len(*in))
		copy(*out, *in)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *InstanceParameterValue) DeepCopyInto(out *InstanceParameterValue) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new InstanceParameterValue.
func (in *InstanceParameterValue) DeepCopy() *InstanceParameterValue {
	if in == nil {
		return nil
	}
	out := new(InstanceParameterValue)
	in.DeepCopyInto(out)
	return out
}
